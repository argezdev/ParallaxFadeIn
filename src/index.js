...
function Paragraph({ image, index, offset, factor, header, aspect, text }) {
  ...
  const left = !(index % 2)
  const color = index % 2 ? "#66ff66" : "#66ff50"
  return (
  ...
  return (
    <>
      ...
      <Block factor={1.2} offset={5.7}>
        <MultilineText top left size={w * 0.15} lineHeight={w / 5} position={[-w / 3.5, 0, -1]} color="#66ff66" text={"four\nzero\nfour"} />
      </Block>
...
function App() {
  ...
  return (
    <>
      ...
      <div className="frame">
        <h1 className="frame__title">Parallax Scroll and Fade-in</h1>
